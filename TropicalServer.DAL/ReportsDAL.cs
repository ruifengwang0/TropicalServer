...
namespace TropicalServer.DAL
{
    ...
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["myConnString"].ToString());
        public DataSet GetItemTypes()
        {

            SqlDataAdapter da = new SqlDataAdapter("Select * from [dbo].[tblItemType]", conn);
        ...
        {
            SqlDataAdapter itemDesc = new SqlDataAdapter("select ItemType, ItemNumber, ItemDescription from [dbo].[tblItem]", conn);
